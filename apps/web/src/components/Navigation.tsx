...
const Navigation: React.FC = () => {
  return (
    <ContainerNav>
      <nav className="box-content flex h-13 items-center justify-between py-5.75 lg:h-24.75 lg:py-9">
        ...
        <div className="hidden h-auto items-center gap-x-11.5 lg:ml-auto lg:flex">
          {navigation.map((item) =>
            item.type === 'button' ? (
              ...
              >
                <span className="font-inter text-gray mr-1.5 text-lg font-medium whitespace-nowrap">
                  {item.label}
                </span>
        ...
        <div className="flex h-11 items-center gap-2.5 lg:hidden">
          <button className="bg-primary flex h-full w-24.75 items-center justify-center rounded-md">
